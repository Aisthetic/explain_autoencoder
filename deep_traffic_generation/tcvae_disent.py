...
from deep_traffic_generation.core.abstract import VAE_disent
if os.name == 'nt':
    import pathlib
...
class TCVAE_disent(VAE_disent, Autoencoder):
...
if __name__ == "__main__":
    cli_main(TCVAE_disent, TrafficDataset, "image", seed=42)
